...
\newcommand{\placetile}[3]{
  ...
  \ifthenelse{\equal{#1}{yellow}}{% 
    \node at (\x+0.25in, \y+0.25in)
          {\includegraphics[width=0.5in]{estrella_polar.png}};
  }{
    ...
    \node at (\x+0.25in, \y+0.25in)
      ...
      \ifthenelse{\equal{#1}{royalazure}}{% 
        \node at (\x+0.25in, \y+0.25in)
              {\includegraphics[width=0.5in]{royal_completo.png}};
      }{
...
\begin{tikzpicture}
  ...
  \ifnum0#1>0 \placetile{yellow}{1}{9} \fi
  \ifnum0#1>1 \placetile{yellow}{1}{7} \fi
  \ifnum0#1>2 \placetile{yellow}{1}{5} \fi

  \ifnum0#2>0 \placetile{royalazure}{5}{11} \fi
  \ifnum0#2>1 \placetile{royalazure}{3}{11} \fi
  \ifnum0#2>2 \placetile{royalazure}{1}{11} \fi

  \ifnum0#3>0 \placetile{lightskyblue}{3}{1} \fi
  \ifnum0#3>1 \placetile{lightskyblue}{5}{1} \fi
  \ifnum0#3>2 \placetile{lightskyblue}{7}{1} \fi

  \ifnum0#4>0 \placetile{red}{7}{3} \fi
  \ifnum0#4>1 \placetile{red}{7}{5} \fi
  \ifnum0#4>2 \placetile{red}{7}{7} \fi
\end{tikzpicture}}
