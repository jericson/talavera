...
\begin{tikzpicture}
  ...
  \ifnum0#1>0 \placetile{yellow}{1}{11} \fi
  \ifnum0#1>1 \placetile{yellow}{1}{8} \fi
  \ifnum0#1>2 \placetile{yellow}{1}{5} \fi

  \ifnum0#2>0 \placetile{royalazure}{7}{11} \fi
  \ifnum0#2>1 \placetile{royalazure}{7}{8} \fi
  \ifnum0#2>2 \placetile{royalazure}{7}{5} \fi

  \ifnum0#3>0 \placetile{lightskyblue}{1}{1} \fi
  \ifnum0#3>1 \placetile{lightskyblue}{1}{4} \fi
  \ifnum0#3>2 \placetile{lightskyblue}{1}{7} \fi

  \ifnum0#4>0 \placetile{red}{7}{1} \fi
  \ifnum0#4>1 \placetile{red}{7}{4} \fi
